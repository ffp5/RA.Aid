...
Examples:
  ...
  ra-aid extract-changelog 0.25.0
    ...
    # Validate price-performance-ratio range if provided
    if parsed_args.price_performance_ratio is not None and not (
        0.0 <= parsed_args.price_performance_ratio <= 1.0
    ):
